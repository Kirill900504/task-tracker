...
export function checkInitData(initData: string, botToken: string, now = Date.now()): InitDataCheck {
  ...
  // представление о ней.
  //
  // ЭТОТ расчёт — настоящий, и это проверено не рассуждением: 20.09.2026
  // Кирилл открыл мини-приложение из своего Telegram и вошёл. До правки
  // оттуда же приходило «Подпись не сходится». Запасной расчёт ниже с
  // тех пор не исполнялся ни разу; если будете упрощать — начинайте с
  // него, а эту строку не трогайте.
