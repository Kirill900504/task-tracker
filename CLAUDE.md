...
Лечится отключением самого blockmap (`nsis.differentialPackage: false`,
с 1.0.4): докачка по частям экономит мегабайты у приложения, которое
меняется несколько раз в год, а стоила работающего автообновления.
Проверять выпуск надо не по зелёной галочке, а по списку файлов:
